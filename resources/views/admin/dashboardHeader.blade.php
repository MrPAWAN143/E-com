<header class="sticky top-0 z-99999 flex w-full border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900 lg:border-b">
    <div class="flex grow flex-col items-center justify-between lg:flex-row lg:px-6">
        ...
        <div class="w-full items-center justify-between gap-4 px-5 py-4 shadow-theme-md lg:flex lg:justify-end lg:px-0 lg:shadow-none hidden">
            <div class="flex items-center gap-2 2xsm:gap-3">
                ...
                <div class="relative" x-data="{ dropdownOpen: false, notifying: true }" @click.outside="dropdownOpen = false">
                    <button class="hover:text-dark-900 relative flex h-11 w-11 items-center justify-center rounded-full border border-gray-200 bg-white text-gray-500 transition-colors hover:bg-gray-100 hover:text-gray-700 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-white" @click.prevent="dropdownOpen = ! dropdownOpen; notifying = false">
                        <span class="absolute right-0 top-0.5 z-1 h-2 w-2 rounded-full bg-orange-400 flex">
            ...
            <div class="relative inline-block text-left" id="userDropdownWrapper">
                <!-- Trigger Button -->
                <a href="#" id="userDropdownBtn" class="flex items-center text-gray-700 dark:text-gray-400">
                    <span class="mr-3 h-11 w-11 rounded-full overflow-hidden">
                        <img src="{{ asset('assets/images/categories/men.jpg') }}" class="object-cover w-full h-full" alt="User">
                    </span>
                    <span class="mr-1 block text-theme-sm font-medium">{{ auth()->user()->name }}</span>
                    <svg id="dropdownArrow" class="stroke-gray-500 dark:stroke-gray-400 transition-transform duration-200" width="18" height="20" viewBox="0 0 18 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <!-- Dropdown Menu -->
                <div id="userDropdownMenu" class="hidden absolute right-0 mt-2 w-56 bg-gray-800 text-white rounded-md shadow-lg z-50">
                    <a href="#" class="block px-4 py-2 hover:rounded hover:bg-gray-700">My Account</a>
                    <a href="#" class="block px-4 py-2 hover:rounded hover:bg-gray-700">My Orders</a>
                    <a href="#" class="block px-4 py-2 hover:rounded hover:bg-gray-700">Settings</a>
                    <a href="#" class="block px-4 py-2 hover:rounded hover:bg-gray-700">Billing Data</a>
                    <div class="border-t border-gray-600 my-1"></div>
                     <div class="p-0 text-sm font-medium text-gray-900 dark:text-white">
                        <form action="{{route('logout')}}" method="post" class="block px-4 py-2 hover:bg-gray-100 hover:rounded dark:hover:bg-gray-700">
                            @csrf
